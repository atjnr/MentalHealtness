            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        <div class="thumb">
                            <img src="img/pasar lama tangerang.png" alt="">
                            <a href="#" class="prise"> </a>
                        </div>
                        <div class="place_info">
                            <a href=" "><h3>Pasar Lama Tangerang</h3></a>
                            <p>Jalan Kisamaun, Sukasari, Kota Tangerang, Banten</p>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        <div class="thumb">
                            <img src="img/padang panjang.png" alt="">
                            <a href="#" class="prise"> </a>
                        </div>
                        <div class="place_info">
                            <a href=""><h3>Pasar Kuliner Padang Panjang</h3></a>
                            <p>Jl. Abu Hanifah, Guguk Malintang, Kec. Padang Panjang Tim., Kota Padang Panjang, Sumatera Barat</p>
                            <div class="rating_days d-flex justify-content-between">
                                <span class="d-flex justify-content-center align-items-center">
                                     <i class="fa fa-star"></i> 
                                     <i class="fa fa-star"></i> 
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        <div class="thumb">
                            <img src="img/Pasar Kreneng.png" alt="">
                            <a href="#" class="prise"></a>
                        </div>
                        <div class="place_info">
                            <a href=""><h3>Pasar Kreneng</h3></a>
                            <p>Dangin Puri Kangin, Kec. Denpasar Utara, Kota Denpasar, Bali</p>
                            <div class="rating_days d-flex justify-content-between">
                                <span class="d-flex justify-content-center align-items-center">
                                     <i class="fa fa-star"></i> 
                                     <i class="fa fa-star"></i> 
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        <div class="thumb">
                            <img src="img/Pasar Kuliner Mattirotasi.png" alt="">
                            <a href="#" class="prise"></a>
                        </div>
                        <div class="place_info">
                            <a href=""><h3>Pasar Kuliner Mattirotasi</h3></a>
                            <p>Labukkang, Kec. Ujung, Kota Parepare, Sulawesi Selatan</p>
                            <div class="rating_days d-flex justify-content-between">
                                <span class="d-flex justify-content-center align-items-center">
                                     <i class="fa fa-star"></i> 
                                     <i class="fa fa-star"></i> 
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        <div class="thumb">
                            <img src="img/Pusat Kuliner Pasar Baru Timika.png" alt="">
                            <a href="#" class="prise"></a>
                        </div>
                        <div class="place_info">
                            <a href=""><h3>Pusat Kuliner Pasar Baru Timika</h3></a>
                            <p>Jl. Hasanuddin, Kamoro Jaya, Kec. Mimika Baru, Kabupaten Mimika, Papua</p>
                            <div class="rating_days d-flex justify-content-between">
                                <span class="d-flex justify-content-center align-items-center">
                                     <i class="fa fa-star"></i> 
                                     <i class="fa fa-star"></i> 
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        <div class="thumb">
                            <img src="img/Taman Kuliner Nanga Pinoh.png" alt="">
                            <a href="#" class="prise"></a>
                        </div>
                        <div class="place_info">
                            <a href=""><h3>Taman Kuliner Nanga Pinoh</h3></a>
                            <p> Paal, Kec. Nanga Pinoh, Kabupaten Melawi, Kalimantan Barat</p>
                            <div class="rating_days d-flex justify-content-between">
                                <span class="d-flex justify-content-center align-items-center">
                                     <i class="fa fa-star"></i> 
                                     <i class="fa fa-star"></i> 
