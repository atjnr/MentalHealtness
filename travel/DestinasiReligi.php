            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        <div class="thumb">
                            <img src="img/Masjid istiqlal.png" alt="">
                            <a href="#" class="prise"> </a>
                        </div>
                        <div class="place_info">
                            <a href=" "><h3>Masjid Istiqlal</h3></a>
                            <p>Jl. Taman Wijaya Kusuma, Ps. Baru, </p>
                            <p>Kecamatan Sawah Besar, Kota Jakarta </p>
                            <p>Pusat, Daerah Khusus Ibukota Jakarta</p>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        <div class="thumb">
                            <img src="img/Pura Tanah Lot.png" alt="">
                            <a href="#" class="prise"> </a>
                        </div>
                        <div class="place_info">
                            <a href=""><h3>Pura Tanah Lot</h3></a>
                            <p>Beraban, Kec. Kediri, Kabupaten Tabanan, Bali</p>
                            <div class="rating_days d-flex justify-content-between">
                                <span class="d-flex justify-content-center align-items-center">
                                     <i class="fa fa-star"></i> 
                                     <i class="fa fa-star"></i> 
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        <div class="thumb">
                            <img src="img/Maha Vihara Mojopahit.png" alt="">
                            <a href="#" class="prise"></a>
                        </div>
                        <div class="place_info">
                            <a href=""><h3>Maha Vihara Mojopahit</h3></a>
                            <p>Desa Bejijong, Kecamatan Trowulan, </p>
                            <p>Mojokerto, Provinsi Jawa Timur</p>
                            <div class="rating_days d-flex justify-content-between">
                                <span class="d-flex justify-content-center align-items-center">
                                     <i class="fa fa-star"></i> 
                                     <i class="fa fa-star"></i> 
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        <div class="thumb">
                            <img src="img/Patung Tuhan Yesus Memberkati.png" alt="">
                            <a href="#" class="prise"></a>
                        </div>
                        <div class="place_info">
                            <a href=""><h3>Patung Yesus Memberkati</h3></a>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        <div class="thumb">
                            <img src="img/Klenteng Kwan Sing Bio.png" alt="">
                            <a href="#" class="prise"></a>
                        </div>
                        <div class="place_info">
                            <a href=""><h3>Klenteng Kwan Sing Bio</h3></a>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        <div class="thumb">
                            <img src="img/gua maria.png" alt="">
                            <a href="#" class="prise"></a>
                        </div>
                        <div class="place_info">
                            <a href=""><h3>Gua Maria</h3></a>
                            <p> Dusun Jitar, Desa Sumber Arum, Kecamatan Moyudan, Kabupaten Sleman, DI Yogyakarta</p>
                            <div class="rating_days d-flex justify-content-between">
                                <span class="d-flex justify-content-center align-items-center">
                                     <i class="fa fa-star"></i> 
                                     <i class="fa fa-star"></i> 
