            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        <div class="thumb">
                            <img src="img/Puncak Cartenz.png" alt="">
                            <a href="#" class="prise"> </a>
                        </div>
                        <div class="place_info">
                            <a href=" "><h3>Puncak Cartenz</h3></a>
                            <p>Papua</p>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        <div class="thumb">
                            <img src="img/Paralayang Pulau Samosir.png" alt="">
                            <a href="#" class="prise"> </a>
                        </div>
                        <div class="place_info">
                            <a href=""><h3>Paralayang Pulau Samosir</h3></a>
                            <p>Garoga, Simanindo, Kabupaten Samosir, Sumatera Utara, Indonesia</p>
                            <div class="rating_days d-flex justify-content-between">
                                <span class="d-flex justify-content-center align-items-center">
                                     <i class="fa fa-star"></i> 
                                     <i class="fa fa-star"></i> 
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        <div class="thumb">
                            <img src="img/Susur Gua Kristal.png" alt="">
                            <a href="#" class="prise"></a>
                        </div>
                        <div class="place_info">
                            <a href=""><h3>Susur Gua Kristal</h3></a>
                            <p>Bolok, Kec. Kupang Bar., Kabupaten Kupang, Nusa Tenggara Timur</p>
                            <div class="rating_days d-flex justify-content-between">
                                <span class="d-flex justify-content-center align-items-center">
                                     <i class="fa fa-star"></i> 
                                     <i class="fa fa-star"></i> 
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        <div class="thumb">
                            <img src="img/Tirta Citarik.png" alt="">
                            <a href="#" class="prise"></a>
                        </div>
                        <div class="place_info">
                            <a href=""><h3>Tirta Citarik</h3></a>
                            <p> Jl. Raya Pelabuhanratu KM.27, Kecamatan Cikidang, Kabupaten Sukabumi, Jawa Barat</p>
                            <div class="rating_days d-flex justify-content-between">
                                <span class="d-flex justify-content-center align-items-center">
                                     <i class="fa fa-star"></i> 
                                     <i class="fa fa-star"></i> 
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_place">
                        <div class="thumb">
                            <img src="img/wisata atv.png" alt="">
                            <a href="#" class="prise"></a>
                        </div>
                        <div class="place_info">
                            <a href=""><h3>ATV Sidoarjo</h3></a>
                            <p> Desa Kalisogo, Jabon, Sidoarjo, Jawa Timur</p>
                            <div class="rating_days d-flex justify-content-between">
                                <span class="d-flex justify-content-center align-items-center">
                                     <i class="fa fa-star"></i> 
                                     <i class="fa fa-star"></i> 
