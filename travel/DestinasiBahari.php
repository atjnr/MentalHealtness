        ...
        <div class="row">
          <div class="col-lg-4 col-md-6">
            <div class="single_place">
              <div class="thumb">
                <img src="img/pink beach.png" alt="" />
                <a href="#" class="prise"> </a>
              </div>
              <div class="place_info">
                <a href=" "><h3>Pink Beach</h3></a>
                <p>Sekaroh, Jerowaru, Kabupaten Lombok Timur, Nusa Tenggara Barat</p>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="single_place">
              <div class="thumb">
                <img src="img/nihiwatu.png" alt="" />
                <a href="#" class="prise"> </a>
              </div>
              <div class="place_info">
                <a href=""><h3>Pantai Nihiwatu</h3></a>
                <p>Kota Waikabubak, Kabupaten Sumba Barat, Nusa Tenggara Timur</p>
                <div class="rating_days d-flex justify-content-between">
                  <span class="d-flex justify-content-center align-items-center">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="single_place">
              <div class="thumb">
                <img src="img/bunaken.png" alt="" />
                <a href="#" class="prise"></a>
              </div>
              <div class="place_info">
                <a href=""><h3>Taman Nasional Bunaken</h3></a>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="single_place">
              ...
              <div class="place_info">
                <a href=""><h3>Raja Ampat</h3></a>
                <p>Kepala Burung (Vogelkoop) Pulau Papua</p>
                <div class="rating_days d-flex justify-content-between">
                  <span class="d-flex justify-content-center align-items-center">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="single_place">
              <div class="thumb">
                <img src="img/mentawai.png" alt="" />
                <a href="#" class="prise"></a>
              </div>
              <div class="place_info">
                <a href=""><h3>Mentawai</h3></a>
                <p>Kepulauan Mentawai, Sumatera Barat</p>
                <div class="rating_days d-flex justify-content-between">
                  <span class="d-flex justify-content-center align-items-center">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="single_place">
              <div class="thumb">
                <img src="img/pulau derawan.png" alt="" />
                <a href="#" class="prise"></a>
              </div>
              <div class="place_info">
                <a href=""><h3>Pulau Derawan</h3></a>
                <p>Kabupaten Berau, Kalimantan Timur</p>
                <div class="rating_days d-flex justify-content-between">
                  <span class="d-flex justify-content-center align-items-center">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
