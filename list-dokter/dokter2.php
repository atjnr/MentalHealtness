...
if (isset($_POST['submit'])) {
    header("Location: ../payment/payment2.php");
}
?>
  ...
  <body>
    ...
    <div class="profile">
      ...
      <div class="profile-box">
        <img src="../img/dokter-2.jpg" class="img" />
        <div class="profil">
          <h5>dr. Dwidjo Saputro, SpKJ (K)</h5>
      ...
      <div class="about-dokter">
        ...
        <div class="detail">
          ...
          <h6>Spesialisasi</h6>
          <p>dr. Dwidjo Saputro, SpKJ (K) merupakan seorang Dokter Spesialis Kesehatan Jiwa (Psikiatri).</p>
          <h6>Pengalaman</h6>
          <p>6 Tahun</p>
          <h6>Rating</h6>
          <p>97%</p>
