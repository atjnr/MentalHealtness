...
if (isset($_POST['submit'])) {
    header("Location: ../payment/payment6.php");
}
?>
  ...
  <body>
    ...
    <div class="profile">
      ...
      <div class="profile-box">
        <img src="../img/dokter-6.jpg" class="img" />
        <div class="profil">
          <h5>Dewiarti Soemantri, SPsi</h5>
          <p>Psikologi - Psikolog</p>
          <h4>Rp 35.000</h4>
        </div>
      </div>
      <div class="about-dokter">
        ...
        <div class="detail">
          ...
          <p>Hospital Yogyakarta</p>
          <h6>Spesialisasi</h6>
          <p>Dewiarti Soemantri, SPsi merupakan seorang Dokter Psikologi (Psikolog).</p>
          <h6>Pengalaman</h6>
          <p>2 Tahun</p>
          <h6>Rating</h6>
          <p>100%</p>
