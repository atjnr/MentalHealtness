...
if (isset($_POST['submit'])) {
    header("Location: ../payment/payment1.php");
}
?>
  ...
  <body>
    ...
    <div class="profile">
      ...
      <div class="profile-box">
        <img src="../img/dokter-1.jpg" class="img" />
        <div class="profil">
          <h5>Dr. dr. Tjhin Wiguna, SpKJ (K)</h5>
      ...
      <div class="about-dokter">
        ...
        <div class="detail">
          ...
          <h6>Spesialisasi</h6>
          <p>Dr. dr. Tjhin Wiguna, SpKJ (K) merupakan seorang Dokter Spesialis Kesehatan Jiwa (Psikiatri).</p>
          <h6>Pengalaman</h6>
          <p>4 Tahun</p>
          <h6>Rating</h6>
          <p>97%</p>
