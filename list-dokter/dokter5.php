...
if (isset($_POST['submit'])) {
    header("Location: ../payment/payment5.php");
}
?>
  ...
  <body>
    ...
    <div class="profile">
      ...
      <div class="profile-box">
        <img src="../img/dokter-5.jpg" class="img" />
        <div class="profil">
          <h5>dr. Darien Alfa Cipta, SpKJ</h5>
      ...
      <div class="about-dokter">
        ...
        <div class="detail">
          ...
          <p>Hospital Jakarta</p>
          <h6>Spesialisasi</h6>
          <p>dr. Darien Alfa Cipta, SpKJ merupakan seorang Dokter Spesialis Kesehatan Jiwa (Psikiatri).</p>
          <h6>Pengalaman</h6>
          <p>5 Tahun</p>
          <h6>Rating</h6>
          <p>100%</p>
    ...
    <div class="jadwal">
      ...
      <form action="" method="POST">
        <div class="detail">
          <h6>Status</h6>
          <div class="status">
            <img class="image" src="../img/status-offline.png" style="border-radius: 50px 50px; width: 75px; height: 25px" />
            <p>Online</p>
          </div>
          <input type="submit" value="Mulai Chat" name="submit" disabled/>
        </div>
        <br />
      </form>
    </div>
