    ...
    <div class="container-fluid p-0 mb-5">
      <div class="owl-carousel header-carousel position-relative">
        <div class="owl-carousel-item position-relative">
          <img class="img-fluid" src="img/health-1.jpg" alt="" />
            ...
            <div class="container">
              <div class="row justify-content-start">
                <div class="col-sm-10 col-lg-8">
                  <h5 class="text-primary text-uppercase mb-3 animated slideInDown">Website Kesehatan Mental</h5>
                  <h1 class="display-3 text-white animated slideInDown">Buat Janji Mudah dan Cepat</h1>
                  <p class="fs-5 text-white mb-4 pb-2">
                    Psikologi bukan hanya untuk orang sakit jiwa. Yuk ngobrol dengan psikolog terbaik pilihan kami. Kamu bisa ngobrol soal asmara, pendidikan, urusan kantor, hingga masalah pribadi. Semua obrolan dijamin kerahasiannya.
                  </p>
        ...
        <div class="owl-carousel-item position-relative">
          <img class="img-fluid" src="img/health-2.jpeg" alt="" />
          <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(24, 29, 56, 0.7)">
            <div class="container">
              <div class="row justify-content-start">
                <div class="col-sm-10 col-lg-8">
