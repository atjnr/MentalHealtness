    ...
    <div class="chatbox-toggle">
		...
		<div class="chatbox-message-header">
			<div class="chatbox-message-profile">
				<img src="../img/dokter-1.jpg" class="imeg chatbox-message-image">
				<div class="profil">
					<h4 class="chatbox-message-name">Dr. dr. Tjhin Wiguna, SpKJ (K)</h4>
		...
		<div class="chatbox-message-content">
			<div class="chatbox-message-item received">
				...
				<img src="../img/dokter-1.jpg" class="images">
				<p class="nama">Dr. dr. Tjhin Wiguna, SpKJ (K) bergabung dalam chat</p>
				</span>
			</div>
			<div class="chatbox-message-item received">
				<span class="chatbox-message-item-text">
					<p>Halo <?php echo $_SESSION['username']; ?>,
					saya Dr. dr. Tjhin Wiguna ada yang bisa saya bantu?</p>
				</span>
			</div>
